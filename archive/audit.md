...
Le PDF peut-il actuellement être envoyé à un auteur ou à une éditrice pour validation ?
...
Le PDF peut-il actuellement être envoyé à l'impression sans reprise manuelle lourde ?
...
Le HTML peut-il actuellement être publié comme édition numérique institutionnelle ?
...
Les cinq corrections qui feraient progresser le plus fortement la qualité éditoriale réelle :corriger le squelette PDF : liminaires, table des matières, métadonnées, signets, destinations PDF ;

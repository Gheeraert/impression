...
def run_reversible_export_for_file(
    ...
    latex_path, roundtrip_xml_path, diagnostics_path = _output_paths(source_path, resolved_output_dir)
...
def _output_paths(source_path: Path, output_dir: Path) -> tuple[Path, Path, Path]:

...
% Ces commandes sont transparentes lors de la restauration XML :
% le lecteur LaTEI parcourt leur contenu sans créer d'élément TEI.
% ---------------------------------------------------------------------------

% \lateiNoIndent{...} — supprime le retrait de première ligne du contenu.
% Usage : corriger l'indentation d'un paragraphe après un élément flottant,
% un titre ou une citation, sans modifier le XML source.

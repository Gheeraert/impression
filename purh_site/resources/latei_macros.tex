...
% Retour à la ligne + retrait + gras dans une entrée de TDM (référentiel
% §9.1) : \titlecontents (contrairement à \@dottedtocline du noyau) type-
% set chaque entrée comme un paragraphe à retrait suspendu — un "\\" y
% force une nouvelle ligne, contrairement à \par qui romprait le
% paragraphe entier de la TDM plutôt que la seule entrée en cours.
    ...
    \tl_if_empty:NF \g_latei_pending_toc_title_tl
      {
        ...
        \else
          \addcontentsline{toc}{chapter}{\tl_use:N \g_latei_pending_toc_title_tl \lateiTocAuthorBreak \lateiSignatureAuthor}
        \fi

    ...
    \tl_if_empty:NF \l_latei_option_page_title_tl
      {
        ...
        \markboth{\tl_use:N \l_latei_option_page_title_tl}{\tl_use:N \l_latei_option_page_title_tl}
...
\NewDocumentCommand{\lateiRenderHead}{m}{%
  \IfStrEq{\lateiHeadContext}{part}{\part*{#1}\markboth{#1}{#1}\addcontentsline{toc}{part}{#1}}{%
  \IfStrEq{\lateiHeadContext}{chapter}{\chapter{#1}\markboth{#1}{#1}}{%
    \IfStrEq{\lateiHeadContext}{unnumberedchapter}{\chapter*{#1}\markboth{#1}{#1}\addcontentsline{toc}{chapter}{#1}}{%
...
\NewDocumentEnvironment{teiElement}{O{} +b}{%
  \IfSubStr{#1}{name={teiHeader}}{}{%
    \IfSubStr{#1}{name={group}}{%
      ...
      \IfSubStr{#1}{name={back}}{\lateiEnsureBackMatter #2}{#2}%
    }%
  }%
}{}

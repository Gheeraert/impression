...
% ne pas les dupliquer ailleurs. Styles provisoires : le calibrage exact de
% la titraille PURH (Josefin Sans Thin, corps ciblés) est hors périmètre de
% cette passe et relève d'une micropasse dédiée.
\newcommand{\lateiContributionTitle}[1]{%
  \par\vspace{0.5\baselineskip}%
  {\PURHTitleFont\huge\bfseries\raggedright #1\par}%
  \vspace{0.3\baselineskip}%
}
\newcommand{\lateiContributionSubtitle}[1]{%
  {\PURHTitleFont\Large\itshape\raggedright #1\par}%

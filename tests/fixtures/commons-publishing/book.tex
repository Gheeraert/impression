...
\end{teiElement}
			\begin{teiElement}[name={tagsDecl}]
				...
				\begin{teiElement}[name={rendition},xmlid={rendition\_list1},scheme={css}]
list-style-type:upper-roman
\end{teiElement}
				\begin{teiElement}[name={rendition},xmlid={rendition\_list2},scheme={css}]
list-style-type:decimal
\end{teiElement}
				\begin{teiElement}[name={rendition},xmlid={rendition\_list3},scheme={css}]
list-style-type:lower-alpha
\end{teiElement}
				\begin{teiElement}[name={rendition},xmlid={rendition\_list4},scheme={css}]
list-style-type:upper-alpha
\end{teiElement}
				\begin{teiElement}[name={rendition},xmlid={rendition\_list5},scheme={css}]
list-style-type:lower-roman
\end{teiElement}
				\begin{teiElement}[name={rendition},xmlid={rendition\_list6},scheme={css}]
list-style-type:disc
\end{teiElement}
				\begin{teiElement}[name={rendition},xmlid={rendition\_list7},scheme={css}]
list-style-type:circle
\end{teiElement}
				\begin{teiElement}[name={rendition},xmlid={rendition\_list8},scheme={css}]
...
\end{teiDiv}
			\begin{teiDiv}[type={section1},xmlid={section1-002}]
				...
				\teiP[xmlid={p-027}]{Texte \teiNote[place={foot},n={1},xmlid={mon\_id\_num\_4}]{
...
\end{teiCit}
				...
				\begin{teiCit}
					...
					\begin{teiQuote}
Citation \begin{teiElement}[name={anchor},xmlid={anchor\_ref2}]

\end{teiElement}lorem ispum
\end{teiQuote}
				
\end{teiCit}
				\teiP[rend={break},xmlid={p-048}]{* * *}
				\teiP[xmlid={p-049}]{Paragraphe suivant.}
				\teiP[xmlid={p-050}]{Ici \teiRef[target={\#ref\_cit1}]{un lien vers la citation} ; là \teiRef[target={http://www.openedition.org}]{un lien vers un site web} et un \teiRef[target={\#anchor\_ref2}]{lien vers une ancre}.}
				...
				\begin{teiDiv}[type={section2},xmlid={section2-015}]
					...
					\begin{teiFigure}[xmlid={figure9}]
						...
						\begin{teiTable}
							...
							\begin{teiRow}[role={label}]

								\begin{teiCell}[rendition={\#Cell}]
Entête A
\end{teiCell}
								\begin{teiCell}[rendition={\#Cell}]
Entête B
...
\end{teiRow}
							\begin{teiRow}
								...
								\begin{teiCell}[rendition={\#Cell},role={label}]
A1 : titre ligne
\end{teiCell}
								\begin{teiCell}[rendition={\#Cell}]
B1
\end{teiCell}
								\begin{teiCell}[rendition={\#Cell \#rtl}]
للنص أو شكل
\end{teiCell}
...
A2 : titre ligne
\end{teiCell}
								\begin{teiCell}[rendition={\#Cell},cols={2}]
B2, C2
\end{teiCell}
				...
				\begin{teiDiv}[type={section2},xmlid={section2-016}]
					...
					\begin{teiDiv}[type={section3},xmlid={div7}]
						...
						\teiP[xmlid={p-063}]{Une formule mathématique inline \begin{teiFigure}[rend={inline},xmlid={figure-004}]
							...
							\begin{teiElement}[name={formula},notation={latex}]
\textbackslash{}(\textbackslash{}frac\{\{\{\textbackslash{}partial \textasciicircum{}2\}v\}\}\{\{\textbackslash{}partial \{z\textasciicircum{}2\}\}\} = 0\textbackslash{})
\end{teiElement}
...
\end{teiDiv}
					\begin{teiDiv}[type={section3},xmlid={section3-003}]
						...
						\begin{teiFigure}[xmlid={figure-005}]
							...
							\begin{teiElement}[name={formula},notation={latex}]
\textbackslash{}[\textbackslash{}displaystyle \textbackslash{}frac \{d\textasciicircum{}2x\textasciicircum{}a\}\{ds\textasciicircum{}2\}+\textbackslash{}Gamma\_\{bc\}\textasciicircum{}\{a\} \textbackslash{}frac \{dx\textasciicircum{}b\}\{ds\}\textbackslash{}frac \{dx\textasciicircum{}c\}\{ds\}=0\textbackslash{}]
\end{teiElement}
...
\end{teiDiv}
					\begin{teiDiv}[type={section3},xmlid={section3-004}]
						...
						\begin{teiFigure}[xmlid={figure-006}]
							...
							\begin{teiElement}[name={formula},notation={latex}]
\textbackslash{}[\textbackslash{}tag\{2\}n>\{\{n\}\_\{i\}\}\textbackslash{};\textbackslash{}text\{ et \}\textbackslash{};\{\{\textbackslash{}alpha \}\_\{n\}\}\textbackslash{}text\{ est entre \}\{\{\textbackslash{}alpha \}\_\{\{\{n\}\_\{i-1\}\}\}\}\textbackslash{}text\{ et \}\{\{\textbackslash{}alpha \}\_\{\{\{n\}\_\{i\}\}\}\}\textbackslash{}text\{ (strictement)\}\textbackslash{}text\{,\}\textbackslash{}]
\end{teiElement}

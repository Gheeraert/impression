...
class SiteBuilder:
    ...
    def _render_banner(self, site_meta: SiteMeta, theme_assets: ThemeAssets) -> str:
        ...
        parts.append('<a class="site-banner-home" href="index.html">')
        if theme_assets.university_logo_href:
            ...
            parts.append('<span class="site-logo-text">Université de Rouen Normandie</span>')
        if theme_assets.purh_logo_href:
            parts.append(f'<img class="site-logo site-logo--purh" src="{html.escape(theme_assets.purh_logo_href)}" alt="Presses universitaires de Rouen et du Havre">')
        parts.append('</a>')
        parts.append('<div class="site-banner-titles">')
        parts.append('<div class="site-banner-label">Presses universitaires de Rouen et du Havre</div>')
        parts.append(f'<div class="site-banner-book">{html.escape(site_meta.title)}</div>')
        parts.append('</div></div></header>')
        return ''.join(parts)
